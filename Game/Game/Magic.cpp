...
void SC_Magic::Start()
{
	...
	m_all_magic_tex[FIRE].LoadEx("Assets/Sprite/magicFIRE.png", 0);
	m_all_magic_tex[THUNDER].LoadEx("Assets/Sprite/magicTHUNDER.png", 0);
	...
	m_magic_tex = m_all_magic_tex[FIRE];
