...
const Enemy::EneDat			m_enemiesdat[ENEMY_DAT] =
{
	...
	{ STAGE_T_1,			"kinoko",				"ìG",	0,		{ 0.0f,55.0f,-50.0f },	{ 0.0f,5.0f,0.0f }	,	{ 10.0f,10.0f,10.0f } ,	NORMAL},
	{ STAGE_T_BATTLE,		"kinoko",				"ìG",	100,	{ 3.0f,70.0f,3.0f },	{ 0.0f,2.0f,0.0f }	,	{ 10.0f,10.0f,10.0f } ,	NORMAL},
	{ STAGE_1_1,			"golem",				"ìG",	0,		{ 3.0f,55.0f,0.0f },	{ 0.0f,6.0f,0.0f }	,	{ 1.0f,1.0f,1.0f } ,	WIND},
	{ STAGE_1_BATTLE,		"golem",				"ìG",	200,	{ 3.0f,70.0f,3.0f },	{ 0.0f,6.0f,0.0f }	,	{ 1.0f,1.0f,1.0f } ,	WIND},
	{ STAGE_2_1,			"Player",				"ìG",	0,		{ 3.0f,55.0f,0.0f },	{ 0.0f,5.0f,0.0f }	,	{ 1.0f,1.0f,1.0f } ,	FIRE},
	{ STAGE_2_BATTLE,		"Player",				"ìG",	500,	{ 3.0f,70.0f,3.0f },	{ 0.0f,2.0f,0.0f }	,	{ 1.0f,1.0f,1.0f } ,	FIRE},
};
